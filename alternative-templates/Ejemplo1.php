            ...
            <tr>
                ...
                <![endif]-->
                    <div class="outer" style="width:96%;max-width:660px;margin:20px auto;">
                        ...
                        <!-- Usar estas filas para estructurar contenido si es necesario añadir imagenes o fondos con detalles, a partir de aqui generar el resto, se puede cambiar el tamaño de la fuente en los rows
                            <tr>
                            ...
                            Usar esta fila para la imagen, tener cuidado con el formato para que se adapte a la celdilla.
                            <tr>
                                <td style="font-family:Arial,sans-serif;font-size:24px;line-height:28px;font-weight:bold; background-color:#0f1a1e;">
                                    <p style="padding:20px;text-align:center;color:white;">Ejemplo</p>
                                </td>
                            </tr>
                        -->
                            <tr>
