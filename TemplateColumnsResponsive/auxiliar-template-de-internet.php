                ...
                <table role="presentation" style="width:100%;border:0;border-spacing:0;">
                  <tr>
                    <td style="padding:10px 10px 20px 10px;font-family:Arial,sans-serif;font-size:24px;line-height:28px;font-weight:bold;">
                        <img src="https://images.unsplash.com/photo-1490730141103-6cac27aaab94?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8ZnJlZXxlbnwwfHwwfHw%3D&w=1000&q=80" width="640" alt="" style="width:100%;height:auto;" />
                    </td>
                  </tr>
                  <tr>
                ...
                <div class="column" style="width:100%;max-width:330px;display:inline-block;vertical-align:middle;">
                  <div style="padding:10px;">
                    <p style="margin:0;font-family:Arial,sans-serif;font-size:14px;line-height:18px;">
                      <img src="https://thumbs.dreamstime.com/b/woman-praying-free-bird-enjoying-nature-sunset-background-hope-concept-94227839.jpg" width="310" alt="" style="display:block;width:310px;max-width:100%;height:auto;" />
                    </p>
                  </div>
                </div>
                <!--[if mso]>
              ...
              <div class="two-col" style="text-align:center;font-size:0;direction:rtl;">
                    ...
                    <div class="column" style="width:100%;max-width:330px;display:inline-block;vertical-align:middle;">
                        <div style="padding:10px;font-size:14px;line-height:18px;">
                            <p style="margin:0;font-family:Arial,sans-serif;">
                                <img src="https://images.unsplash.com/photo-1490730141103-6cac27aaab94?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8ZnJlZXxlbnwwfHwwfHw%3D&w=1000&q=80" width="310" alt="" style="display:block;width:310px;max-width:100%;height:auto;" />
                            </p>
                        </div>
                    </div>
                    <!--[if mso]>
                ...
                <div class="three-col" style="font-size:0;text-align:center;">
                  ...
                  <div class="column" style="width:100%;max-width:220px;display:inline-block;vertical-align:top;">
                    <div style="padding:10px;font-size:14px;line-height:18px;">
                      <p style="margin-top:0;margin-bottom:10px;font-family:Arial,sans-serif;"><img src="https://www.stockvault.net/data/2019/08/31/269064/thumb16.jpg" width="100" alt="" style="width:100px;max-width:100%;height:auto;" /></p>
                ...
                <div class="sidebar" style="font-size:0;text-align:center;">
                  ...
                  <div class="small" style="width:100%;max-width:100px;display:inline-block;vertical-align:middle;"">
                    <div style="padding:10px;font-size:14px;line-height:18px;">
                      <img src="https://pbs.twimg.com/profile_images/1510972752274112515/YqLy0CK3_400x400.jpg" width="80" alt="" style="width:80px;max-width:100%;height:auto;" />
                    </div>
                  </div>
                  <!--[if mso]>
                  </td>
                  <td style="width:560px;text-align:center;"valign="middle"">
                  <![endif]-->
                ...
                <div class="sidebar" style="font-size:0;text-align:center;direction:rtl;">
                  ...
                  <table role="presentation" width="100%" dir="rtl">
                  <tr>
                  <td style="width:100px;padding:10px;text-align:center;" valign="middle" direction:ltr;>
                  <![endif]-->
                  <div class="small" style="width:100%;max-width:100px;display:inline-block;vertical-align:middle;">
                  ...
                  <td style="width:560px;padding:10px;text-align:center;" valign="middle" direction:ltr;>
                  <![endif]-->
                  <div class="large" style="width:100%;max-width:560px;display:inline-block;vertical-align:middle;">
                      <div style="padding:10px;font-size:14px;line-height:18px;">
